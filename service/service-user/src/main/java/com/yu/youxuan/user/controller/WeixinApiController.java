package com.yu.youxuan.user.controller;

import com.alibaba.fastjson.JSONObject;
import com.yu.youxuan.JwtHelper;
...
import com.yu.youxuan.enums.UserType;
import com.yu.youxuan.enums.user.User;
import com.yu.youxuan.user.service.UserService;
import com.yu.youxuan.user.utils.ConstantPropertiesUtil;
import com.yu.youxuan.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public Result loginWx(@PathVariable String code) {
        ...
        try {
            ...
            throw new YouxuanException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }
